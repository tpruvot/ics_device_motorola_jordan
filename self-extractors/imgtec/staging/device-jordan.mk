...
LOCAL_PATH := vendor/imgtec/jordan

# Imgtec blobs necessary for jordan
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/pvrsrvinit:system/vendor/bin/pvrsrvinit \
    $(LOCAL_PATH)/proprietary/libEGL_POWERVR_SGX530_125.so:system/vendor/lib/egl/libEGL_POWERVR_SGX530_125.so \
    $(LOCAL_PATH)/proprietary/libGLESv1_CM_POWERVR_SGX530_125.so:system/vendor/lib/egl/libGLESv1_CM_POWERVR_SGX530_125.so \
    $(LOCAL_PATH)/proprietary/libGLESv2_POWERVR_SGX530_125.so:system/vendor/lib/egl/libGLESv2_POWERVR_SGX530_125.so \
    $(LOCAL_PATH)/proprietary/gralloc.omap3.so:system/vendor/lib/hw/gralloc.omap3.so \
